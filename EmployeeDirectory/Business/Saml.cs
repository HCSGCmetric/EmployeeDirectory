...
namespace OneLogin
{
    namespace Saml
    {
        ...
        public class AuthRequest
        {
            ...
            //public string LogoutRequest(AuthRequestFormat format)
            //{
            //    using (StringWriter sw = new StringWriter())
            //    {
            //        //XmlWriterSettings xws = new XmlWriterSettings();
            ...
            //        //    xw.WriteAttributeString("Version", "2.0");
            //        //    xw.WriteAttributeString("IssueInstant", issue_instant);
            //        //    xw.WriteAttributeString("Destination", "https://hcsgcorp.onelogin.com/trust/saml2/http-redirect/slo/394863");
            //        //    xw.WriteAttributeString("AssertionConsumerServiceURL", appSettings.assertionConsumerServiceUrl);

            //        //    xw.WriteStartElement("saml", "Issuer", "https://app.onelogin.com/saml/metadata/394863");
            //        //    xw.WriteAttributeString("Format", "urn:oasis:names:tc:SAML:2.0:nameid-format:transient");
            //        //    xw.WriteEndElement();

            //        //    xw.WriteStartElement("saml", "NameID", "urn:oasis:names:tc:SAML:2.0:nameid-format:transient");
            //        //    xw.WriteAttributeString("SPNameQualifier", "https://app.onelogin.com/saml/metadata/394863");
            //        //    xw.WriteString("ONELOGIN_f92cc1834efc0f73e9c09f482fce80037a6251e7");
            //        //    xw.WriteEndElement();
            ...
            //        //    //xw.WriteEndElement();
            //        //}
            //        using (StreamReader sr = new StreamReader(@"E:\Hiren Workspace\Projects\hcsgrest Project\Mobile Log Files\SAML.txt"))
            //        {
